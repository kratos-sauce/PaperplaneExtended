...
@register(outgoing=True, pattern="^.sipp$")
async def sipp(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n╔═╦╦═╦╦╦╗╔═╦╦═╦╦╦╗`"
                     "`\n║╚╣║║║║║║║╚╣║║║║║║`"
...
\n\n.fail\
\nUsage: Custom text FAIL\
\n\n.lol\
\nUsage:Custom text LOL\
\n\n.lool\
\nUsage: Custom text LOOL\
\n\n.stfu\
\nUsage: Custom text STFU\
\n\n.gtfo\
\nUsage: Custom text GTFO\
\n\n.siap\
\nUsage: ya kastem SIAP\
\n\n.sipp\
\nUsage: YAK SIP SIP\
\n\n.sip\
\nUsage: Yaudah sip\
...
\nUsage: Custom Text\
\n\n.taco\
\nUsage: try and reply to someone!\
\n\n.huh\
\nUsage: This memes\
\n\n.huhu\
\nUsage: maybe this memes error\
\n\n.paw\
\nUsage: try by your self\
\n\n\.tf\
\nUsage: ....\
\n\n.gey\
\nUsage: some memes haha\
\n\n.gay\
\nUsage: Gay lu yak?\
\n\n.bot\
\nUsage: nih robot\
